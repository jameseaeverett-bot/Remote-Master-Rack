const rmrTools = [
  { slug: 'daw-detectives', name: 'DAW Detectives', cardDescription: 'A practical RMR studio tool in development.', detailIntro: 'A practical RMR studio tool in development.', description: 'A practical RMR studio tool in development.', visualLabel: 'DETECTIVES', status: 'In Development', availability: 'Windows availability will be announced when verified.', requirements: 'This product is in development. Features and release information will be published only when verified.' },
  { slug: 'compare', name: 'COMPARE', cardDescription: 'A focused comparison tool in development for critical listening workflows.', detailIntro: 'A focused comparison tool in development for critical listening workflows.', description: 'A focused comparison tool in development for critical listening workflows.', visualLabel: 'COMPARE', status: 'In Development', availability: 'Platform availability will be announced when verified.', requirements: 'This product is in development. Features and release information will be published only when verified.' },
];
...
const renderToolGallery = () => {
  ...
  rmrTools.forEach((baseTool) => {
    ...
    const description = document.createElement('p'); description.className = 'editor-card__description'; description.textContent = tool.cardDescription; description.hidden = tool.cardDescription === '';
...
const renderToolDetail = () => {
  ...
  detail.querySelector('[data-tool-description]').textContent = tool.detailIntro;
